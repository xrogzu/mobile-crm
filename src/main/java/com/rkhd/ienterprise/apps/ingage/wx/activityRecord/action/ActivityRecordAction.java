package com.rkhd.ienterprise.apps.ingage.wx.activityRecord.action;
...
@Namespace("/wx/activityrecord")
public class ActivityRecordAction extends WxBaseAction {
    ...
    @Action(value = "create", results = {@Result(name = SUCCESS, location = PAGES_ROOT+"/activityrecord/activityrecord_create.jsp")})
    public String createPage() throws Exception{

        return  SUCCESS;
    }
    @Action(value = "qiandao", results = {@Result(name = SUCCESS, location = PAGES_ROOT+"/activityrecord/activityrecord_qiandao.jsp")})
    public String qiandaoPage() throws Exception{

        return  SUCCESS;
    }
    @Action(value = "index", results = {@Result(name = SUCCESS, location = PAGES_ROOT+"/activityrecord/activityrecord_index.jsp")})
