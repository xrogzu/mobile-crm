...
public enum Browser {
    ...
    IE10(                    Manufacturer.MICROSOFT, Browser.IE, 45, "Internet Explorer 10", new String[] { "MSIE 5" }, null, BrowserType.WEB_BROWSER, RenderingEngine.TRIDENT, null ), // before MSIE
    IE11(                    Manufacturer.MICROSOFT, Browser.IE, 40, "Internet Explorer 11", new String[] { "MSIE 5" }, null, BrowserType.WEB_BROWSER, RenderingEngine.TRIDENT, null ), // before MSIE
