...
public class SetSystemProp{
    protected  static final Logger LOG = LoggerFactory.getLogger(SetSystemProp.class);
...
//    }
    ...
    public static void loadConfig(String file) {
        try {
            file = SetSystemProp.class.getClassLoader().getResource(file).getPath().toString();
            LOG.info("file_path="+file);

            SetSystemProp.profilepath = file;
    ...
    public static void writeProperties(String keyname,String keyvalue) {
        try {
            if(keyvalue != null){
                LOG.info("keyname="+keyname+":keyvalue="+keyvalue);
                ...
                LOG.error("keyname="+keyname+":keyvalue="+keyvalue);
            }
    ...
    public static void main(String[] args) {
        ...
        //readValue("/temp/test.properties", "MAIL_SERVER_INCOMING");
