 ...
 * 增加子管理员
 */
public class OrgAdminAddThread  extends Thread{
    private static final Logger LOG = LoggerFactory.getLogger(OrgAdminAddThread.class);
    ...
    public OrgAdminAddThread(String thirdCorpid, JSONArray userIds, RelThirdTokenService relThirdTokenService, CommonService commonService,RelThirdCorpXsyTenantService relThirdCorpXsyTenantService){
        super();
        ...
        try {
            ...
            if(relThirdCorpXsyTenant == null){
                ...
                for(int i=0 ;i<userIds.size();i++){
                    ...
                    //执行同步用户角色
                    commonService.setDingUserRole(dingUserDetail,this.thirdCorpid, tenantParam,roleMap,responsibilityMap,true);
                }
