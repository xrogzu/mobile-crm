 ...
 */
public class DingAuthInterceptor extends MethodFilterInterceptor {


    private static final long serialVersionUID = 7175284785643072977L;

    private static final Logger LOG = LoggerFactory.getLogger(DingAuthInterceptor.class);
