package com.rkhd.ienterprise.apps.ingage.dingtalk.helper.utils.aes;
...
public class DingTalkEncryptor {
    private  static Logger LOG = LoggerFactory.getLogger(DingTalkEncryptor.class);
    ...
    private String decrypt(String text) throws DingTalkEncryptException {
        ...
        // corpid不相同的情况
        LOG.info("fromCorpid="+fromCorpid +"; corpId="+corpId);
