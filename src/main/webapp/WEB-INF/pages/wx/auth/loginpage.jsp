...
<%--https://ddtest2.xiaoshouyi.com/mweb/wx/auth/yinDaoShouQuan.action--%>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <!--banner-->
    <div class="banner">
        <div class="banner-btn"><a href="javascript:doYinDao()"  >立即开通</a></div>
    </div>
    <!--choice-->
    ...
    <div class="about">
        ...
        <div class="about-msg">
            <p>销售易是一家移动互联时代创新型销售管理服务商，帮助企业提升销售管理执行力和业绩;成立4年来赢得了包括分众传媒、滴滴出行、米其林、易华录、科锐配电等知名企业在内的十几万名客户的信任，并获得顶级风投红杉资本、经纬中国的鼎力支持，一举成为移动互联时代的销售管理领军企业，致力成为世界级最专业、最创新的销售管理服务商。</p>
